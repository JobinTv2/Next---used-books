...
const Container = tw.div`h-[fit-content] w-[250px] max-h-[350px] min-h-[400px] relative flex flex-col items-center justify-between p-5 bg-gray-100  rounded cursor-pointer shadow-md`;
